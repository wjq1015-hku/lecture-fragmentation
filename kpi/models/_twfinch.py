# source code from original author: https://github.com/ssarfraz/FINCH-Clustering/blob/master/TW-FINCH/python/twfinch.py
import time
import argparse
import numpy as np
    ...
    if req_clust is not None:
        if req_clust not in num_clust:
            ...
            try:
                ...
                req_c = req_numclust(c[:, last_ind], data, req_clust, distance, use_tw_finch=tw_finch)
        else:
